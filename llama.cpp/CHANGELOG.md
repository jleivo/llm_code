...
- `README.md` with usage, configuration, and port documentation
- Pester unit tests covering configuration, arguments, process management,
  cleanup logic, and `.bat` delegation
